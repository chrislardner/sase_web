...
const SponsorshipPackages = () => {
    return (
        <section className="mb-12 p-8 bg-secondary-light text-white rounded-lg shadow-xl transform transition hover:scale-105 fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 bg-white text-text-light rounded-lg shadow hover:shadow-xl transition">
            ...
            <div className="mt-12 p-8 bg-white text-text-light rounded-lg shadow hover:shadow-xl transform transition hover:scale-105">
