...
const SponsorshipPackages = () => {
    return (
        <section
            className="mb-12 p-8 bg-secondary-light text-white rounded-lg shadow-xl transform transition hover:scale-105 fade-in">
            ...
            <div
                className="mt-12 p-8 bg-white text-text-light rounded-lg shadow hover:shadow-xl transform transition hover:scale-105">
